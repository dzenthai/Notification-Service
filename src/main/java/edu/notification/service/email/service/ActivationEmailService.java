...
public class ActivationEmailService {
    ...
    @Autowired
    public ActivationEmailService(JavaMailSender mailSender, TemplateEngine templateEngine) {
    ...
    public void activateUserEmail(String to) throws MessagingException {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);

        String subject = "Registration Success";
        String content = buildEmailContent(to);
